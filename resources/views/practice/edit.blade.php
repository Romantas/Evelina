                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('practice.update',$practice->id) }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input id="title" type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" value="{{ $practice->title }}" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <textarea id="body" type="text" class="form-control{{ $errors->has('body') ? ' is-invalid' : '' }}" name="body">{{ $practice->body }}</textarea>
                                    </div>
                                </div>
